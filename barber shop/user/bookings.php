  ...
  <div class="col-12">
    ...
    <div class="table-responsive mt-2">
      <table class="table table-bordered table-striped text-center">
        ...
        <tr>
          <td colspan="12">
            <h4 class="text-center text-white m-0">! ! ! Your Bookings ! ! !</h4>
          </td>
        </tr>
        <tr>
      ...
      <tbody>
        <?php 
          ...
          $q="SELECT booking.bid, booking.hour, booking.min, booking.ampm, booking.status, booking.reason, product.pname, product.pimage, product.price, product.type, product.gender, user.uid
          FROM ((booking
          INNER JOIN product ON booking.pid = product.pid)
          INNER JOIN user ON booking.uid = user.uid) WHERE booking.uid='$uid'";
